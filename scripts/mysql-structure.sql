...
--
-- Table structure for table `scoresab`
--

DROP TABLE IF EXISTS `scoresab`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scoresab` (
  `scoreid` bigint(20) NOT NULL AUTO_INCREMENT,
  `scorekey` varchar(512) DEFAULT NULL,
  ...
  `details` varchar(128) DEFAULT NULL,
  `hits_taken` bigint(20) GENERATED ALWAYS AS (floor(12 * log(1 - `damage_penalty` / (`exploration_bonus` * 0.8)) / log(0.8))) VIRTUAL,
  `shortenedline` tinyint(1) DEFAULT 0,
  `dlc` varchar(5) GENERATED ALWAYS AS ('ab') VIRTUAL,
  PRIMARY KEY (`scoreid`),
  UNIQUE KEY `idx_scoreid` (`scoreid`),
  UNIQUE KEY `scorekey` (`scorekey`),
  KEY `idx_steamid` (`steamid`),
  KEY `idx_time` (`time`),
  KEY `idx_score` (`score`),
  KEY `idx_goal` (`goal`),
  ...
  KEY `idx_date` (`date`),
  KEY `idx_recentresults` (`date`,`score`,`time`,`level`,`steamid`)
) ENGINE=InnoDB AUTO_INCREMENT=15677949 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `scoresabp`
--

DROP TABLE IF EXISTS `scoresabp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scoresabp` (
  `scoreid` bigint(20) NOT NULL AUTO_INCREMENT,
  `scorekey` varchar(512) DEFAULT NULL,
  `date` int(11) DEFAULT NULL,
  `steamid` bigint(20) DEFAULT NULL,
  ...
  `hits_taken` bigint(20) GENERATED ALWAYS AS (floor(12 * log(1 - `damage_penalty` / (`exploration_bonus` * 0.8)) / log(0.8))) VIRTUAL,
  `shortenedline` tinyint(1) DEFAULT 0,
  `dlc` varchar(5) GENERATED ALWAYS AS ('abp') VIRTUAL,
  PRIMARY KEY (`scoreid`),
  UNIQUE KEY `idx_scoreid` (`scoreid`),
  UNIQUE KEY `scorekey` (`scorekey`),
  KEY `idx_date` (`date`),
  ...
  KEY `idx_scorerank` (`scorerank`),
  KEY `idx_recentresults` (`date`,`score`,`time`,`level`,`steamid`)
) ENGINE=InnoDB AUTO_INCREMENT=23364491 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `scoresr`
--

DROP TABLE IF EXISTS `scoresr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scoresr` (
  `scoreid` bigint(20) NOT NULL AUTO_INCREMENT,
  `scorekey` varchar(512) DEFAULT NULL,
  `date` int(11) DEFAULT NULL,
  `steamid` bigint(20) DEFAULT NULL,
  ...
  `hits_taken` bigint(20) GENERATED ALWAYS AS (floor(12 * log(1 - `damage_penalty` / (`exploration_bonus` * 0.8)) / log(0.8))) VIRTUAL,
  `shortenedline` tinyint(1) DEFAULT 0,
  `dlc` varchar(5) GENERATED ALWAYS AS ('rep') VIRTUAL,
  PRIMARY KEY (`scoreid`),
  UNIQUE KEY `idx_scoreid` (`scoreid`),
  UNIQUE KEY `scorekey` (`scorekey`),
  KEY `idx_date` (`date`),
  ...
  KEY `idx_recentresults` (`date`,`score`,`time`,`level`,`steamid`),
  KEY `idx_date_scorerank` (`date`,`scorerank`)
) ENGINE=InnoDB AUTO_INCREMENT=394290894 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `scoresunion`
--

DROP TABLE IF EXISTS `scoresunion`;
/*!50001 DROP VIEW IF EXISTS `scoresunion`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `scoresunion` AS SELECT
 1 AS `scoreid`,
  1 AS `scorekey`,
  1 AS `date`,
  1 AS `steamid`,
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dailylb_scores_rep` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET collation_connection  = utf8_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`greedierbutt`@`localhost` PROCEDURE `dailylb_scores_rep`(IN lb_date BIGINT)
BEGIN
SELECT
    ...
    RANK() OVER(ORDER BY s.score DESC, s.time ASC) AS rank,
    s.score AS score,
...
--
-- Final view structure for view `alldaily_scores_ab`
--
...
/*!50001 VIEW `alldaily_scores_ab` AS select `p`.`personaname` AS `player`,`p`.`avatar` AS `avatar`,`s`.`scoreid` AS `scoreid`,`s`.`date` AS `date`,`s`.`steamid` AS `steamid`,rank() over ( partition by `s`.`date` order by `s`.`score` desc,`s`.`time`) AS `scorerank`,rank() over ( partition by `s`.`date` order by `s`.`level` desc,`s`.`time`,`s`.`score` desc) AS `timerank`,`s`.`score` AS `score`,`s`.`stage_bonus` AS `stage_bonus`,`s`.`exploration_bonus` AS `exploration_bonus`,`s`.`schwag_bonus` AS `schwag_bonus`,`s`.`rush_bonus` AS `rush_bonus`,`s`.`bluebaby_bonus` AS `bluebaby_bonus`,`s`.`lamb_bonus` AS `lamb_bonus`,`s`.`megasatan_bonus` AS `megasatan_bonus`,`s`.`damage_penalty` AS `damage_penalty`,`s`.`hits_taken` AS `hits_taken`,`s`.`time_penalty` AS `time_penalty`,`s`.`item_penalty` AS `item_penalty`,`s`.`level` AS `level`,`s`.`time` AS `time`,`s`.`goal` AS `goal` from (`profiles` `p` join `scoresab` `s` on(`p`.`steamid` = `s`.`steamid`)) where `p`.`blacklisted` = 0 order by `s`.`date`,`p`.`personaname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `alldaily_scores_abp`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`greedierbutt`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `alldaily_scores_abp` AS select `p`.`personaname` AS `player`,`p`.`avatar` AS `avatar`,`s`.`scoreid` AS `scoreid`,`s`.`date` AS `date`,`s`.`steamid` AS `steamid`,rank() over ( partition by `s`.`date` order by `s`.`score` desc,`s`.`time`) AS `scorerank`,rank() over ( partition by `s`.`date` order by `s`.`level` desc,`s`.`time`,`s`.`score` desc) AS `timerank`,`s`.`score` AS `score`,`s`.`stage_bonus` AS `stage_bonus`,`s`.`exploration_bonus` AS `exploration_bonus`,`s`.`schwag_bonus` AS `schwag_bonus`,`s`.`rush_bonus` AS `rush_bonus`,`s`.`bluebaby_bonus` AS `bluebaby_bonus`,`s`.`lamb_bonus` AS `lamb_bonus`,`s`.`megasatan_bonus` AS `megasatan_bonus`,`s`.`damage_penalty` AS `damage_penalty`,`s`.`hits_taken` AS `hits_taken`,`s`.`time_penalty` AS `time_penalty`,`s`.`item_penalty` AS `item_penalty`,`s`.`level` AS `level`,`s`.`time` AS `time`,`s`.`goal` AS `goal` from (`profiles` `p` join `scoresabp` `s` on(`p`.`steamid` = `s`.`steamid`)) where `p`.`blacklisted` = 0 order by `s`.`date`,`p`.`personaname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `alldaily_scores_rep`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`greedierbutt`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `alldaily_scores_rep` AS select `p`.`personaname` AS `player`,`p`.`avatar` AS `avatar`,`s`.`scoreid` AS `scoreid`,`s`.`date` AS `date`,`s`.`steamid` AS `steamid`,rank() over ( partition by `s`.`date` order by `s`.`score` desc,`s`.`time`) AS `scorerank`,rank() over ( partition by `s`.`date` order by `s`.`level` desc,`s`.`time`,`s`.`score` desc) AS `timerank`,`s`.`score` AS `score`,`s`.`stage_bonus` AS `stage_bonus`,`s`.`exploration_bonus` AS `exploration_bonus`,`s`.`schwag_bonus` AS `schwag_bonus`,`s`.`rush_bonus` AS `rush_bonus`,`s`.`bluebaby_bonus` AS `bluebaby_bonus`,`s`.`lamb_bonus` AS `lamb_bonus`,`s`.`megasatan_bonus` AS `megasatan_bonus`,`s`.`damage_penalty` AS `damage_penalty`,`s`.`hits_taken` AS `hits_taken`,`s`.`time_penalty` AS `time_penalty`,`s`.`item_penalty` AS `item_penalty`,`s`.`level` AS `level`,`s`.`time` AS `time`,`s`.`goal` AS `goal` from (`profiles` `p` join `scoresr` `s` on(`p`.`steamid` = `s`.`steamid`)) where `p`.`blacklisted` = 0 order by `s`.`date`,`p`.`personaname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `dailylb_entries_rep`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`greedierbutt`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `dailylb_entries_rep` AS select count(`s`.`scoreid`) AS `entries`,`s`.`date` AS `date` from (`scoresr` `s` join `profiles` `p` on(`s`.`steamid` = `p`.`steamid`)) where `p`.`blacklisted` = 0 group by `s`.`date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`greedierbutt`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `scoresunion` AS select `scoresr`.`scoreid` AS `scoreid`,`scoresr`.`scorekey` AS `scorekey`,`scoresr`.`date` AS `date`,`scoresr`.`steamid` AS `steamid`,`scoresr`.`rank` AS `rank`,`scoresr`.`scorerank` AS `scorerank`,`scoresr`.`score` AS `score`,`scoresr`.`stage_bonus` AS `stage_bonus`,`scoresr`.`exploration_bonus` AS `exploration_bonus`,`scoresr`.`schwag_bonus` AS `schwag_bonus`,`scoresr`.`rush_bonus` AS `rush_bonus`,`scoresr`.`bluebaby_bonus` AS `bluebaby_bonus`,`scoresr`.`lamb_bonus` AS `lamb_bonus`,`scoresr`.`megasatan_bonus` AS `megasatan_bonus`,`scoresr`.`damage_penalty` AS `damage_penalty`,`scoresr`.`time_penalty` AS `time_penalty`,`scoresr`.`item_penalty` AS `item_penalty`,`scoresr`.`level` AS `level`,`scoresr`.`time` AS `time`,`scoresr`.`timerank` AS `timerank`,`scoresr`.`goal` AS `goal`,`scoresr`.`details` AS `details`,`scoresr`.`hits_taken` AS `hits_taken`,`scoresr`.`shortenedline` AS `shortenedline`,`scoresr`.`dlc` AS `dlc` from `scoresr` union all select `scoresab`.`scoreid` AS `scoreid`,`scoresab`.`scorekey` AS `scorekey`,`scoresab`.`date` AS `date`,`scoresab`.`steamid` AS `steamid`,`scoresab`.`rank` AS `rank`,`scoresab`.`scorerank` AS `scorerank`,`scoresab`.`score` AS `score`,`scoresab`.`stage_bonus` AS `stage_bonus`,`scoresab`.`exploration_bonus` AS `exploration_bonus`,`scoresab`.`schwag_bonus` AS `schwag_bonus`,`scoresab`.`rush_bonus` AS `rush_bonus`,`scoresab`.`bluebaby_bonus` AS `bluebaby_bonus`,`scoresab`.`lamb_bonus` AS `lamb_bonus`,`scoresab`.`megasatan_bonus` AS `megasatan_bonus`,`scoresab`.`damage_penalty` AS `damage_penalty`,`scoresab`.`time_penalty` AS `time_penalty`,`scoresab`.`item_penalty` AS `item_penalty`,`scoresab`.`level` AS `level`,`scoresab`.`time` AS `time`,`scoresab`.`timerank` AS `timerank`,`scoresab`.`goal` AS `goal`,`scoresab`.`details` AS `details`,`scoresab`.`hits_taken` AS `hits_taken`,`scoresab`.`shortenedline` AS `shortenedline`,`scoresab`.`dlc` AS `dlc` from `scoresab` union all select `scoresabp`.`scoreid` AS `scoreid`,`scoresabp`.`scorekey` AS `scorekey`,`scoresabp`.`date` AS `date`,`scoresabp`.`steamid` AS `steamid`,`scoresabp`.`rank` AS `rank`,`scoresabp`.`scorerank` AS `scorerank`,`scoresabp`.`score` AS `score`,`scoresabp`.`stage_bonus` AS `stage_bonus`,`scoresabp`.`exploration_bonus` AS `exploration_bonus`,`scoresabp`.`schwag_bonus` AS `schwag_bonus`,`scoresabp`.`rush_bonus` AS `rush_bonus`,`scoresabp`.`bluebaby_bonus` AS `bluebaby_bonus`,`scoresabp`.`lamb_bonus` AS `lamb_bonus`,`scoresabp`.`megasatan_bonus` AS `megasatan_bonus`,`scoresabp`.`damage_penalty` AS `damage_penalty`,`scoresabp`.`time_penalty` AS `time_penalty`,`scoresabp`.`item_penalty` AS `item_penalty`,`scoresabp`.`level` AS `level`,`scoresabp`.`time` AS `time`,`scoresabp`.`timerank` AS `timerank`,`scoresabp`.`goal` AS `goal`,`scoresabp`.`details` AS `details`,`scoresabp`.`hits_taken` AS `hits_taken`,`scoresabp`.`shortenedline` AS `shortenedline`,`scoresabp`.`dlc` AS `dlc` from `scoresabp` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
